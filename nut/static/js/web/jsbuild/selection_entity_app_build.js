...
if ( typeof define === 'function' && define.amd ) {
  // AMD
  define( 'jquery_bridget',[ 'jquery' ], defineBridget );
} else if ( typeof exports === 'object' ) {
  defineBridget( require('jquery') );
} else {
  // get jquery from browser global
