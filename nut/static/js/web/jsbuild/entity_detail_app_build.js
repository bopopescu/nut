...
define('subapp/entitylike',['libs/Class','subapp/account','jquery','fastdom'],
    ...
    var AppEntityLike = Class.extend({
        init: function(){
            ...
            $('#hot-entity-list,.tag-page-container').on('click','.new-btn-like',this.handleLike.bind(this));
...
define('subapp/entityreport',['jquery',
        'bootbox',
        'libs/Class'
    ],
    function(
...
define('subapp/entity/detail_image_slick',['jquery', 'libs/Class','libs/slick','fastdom'], function(
    $, Class, slick , fastdom
){
...
define('models/Entity',['Backbone', 'libs/Class'],function(Backbone, Class){
...
define('views/base/ItemView',['Backbone','libs/underscore'], function(
    Backbone,
    _
){
...
define('subapp/entity/entity_share',['jquery', 'libs/Class','underscore','bootbox','libs/qrcode'], function(
    $, Class,_,bootbox
){
