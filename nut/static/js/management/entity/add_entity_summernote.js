...
(function (factory) {
  ...
  var Button = function () {
     ...
     * @param {Object} styleInfo
     */
    this.update = function ($container, styleInfo,currentTarget) {
      /**
  ...
  var Toolbar = function () {
    ...
    this.update = function ($toolbar, styleInfo, currentTarget) {
      button.update($toolbar, styleInfo,currentTarget);
    };
  ...
  var DragAndDrop = function (handler) {
    ...
    var html=(function(){
        ...
        var regId =    /(<[^>]+) id=".*?"/img;
        var regHeaderFront = /(<h[1-9])/img;
        var regHeaderEnd = /(<\/h[1-9]>)/img;
        ...
        function removeId(htmlStr){
            return htmlStr.replace(regId, function(all,v){return v;});
        }

        function replaceHeaderWithH3(htmlStr){
            htmlStr =   htmlStr.replace(regHeaderFront, function(all,v){ return '<h3' ;});
            htmlStr =   htmlStr.replace(regHeaderEnd, function(all, v){ return '</h3>' ;});
            return htmlStr;
        }
        return {
            ...
            replaceHeaderWithH3: replaceHeaderWithH3
        }
    })();
    ...
    var Clipboard = function (handler) {
        ...
        // TODO : handle more imageItems later
        function getImageItemFromClipBoard(clpData){
            if (!clpData.items ||!clpData.items.length) {
                return null;
            }
            items = clpData.items;
        ...
        var hPasteClipboardImage = function (event) {
            ...
            var item =  getImageItemFromClipBoard(clipboardData);
            //var item = list.head(clipboardData.items);
            var isClipboardImage =  item && item.kind === 'file' && item.type.indexOf('image/') !== -1;
...
/**
    ...
    var hToolbarAndPopoverUpdate = function (event) {
      ...
      setTimeout(function () {
        ...
        if (!isAirMode) {
          modules.toolbar.update(layoutInfo.toolbar(), styleInfo, event.currentTarget || event.target);
        }
    ...
    var hToolbarAndPopoverClick = function (event) {
      ...
      if ($btn.length) {
        ...
        // add by An for blockquote remove
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      if ("/management/entity/add/" !== window.location.pathname && "/seller_management/add_entity/" !== window.location.pathname) {
