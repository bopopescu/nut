...
from apps.order.views.web.order import UserOrderListView, UserOrderView,OrderWeixinPaymentView, OrderAlipayQrcodeView
...
urlpatterns = patterns(
    ...
    url(r'^(?P<pk>\d+)/alipay_qrcode/$', OrderAlipayQrcodeView.as_view(), name='web_user_order_alipay_qrcode'),
