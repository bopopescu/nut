...
class SellerView(ListView):
    ...
    def get_seller_entities(self, seller_queryset):
        ...
        entities = Entity.objects.filter(related_articles__in=article_list).distinct('id')
        return entities
    ...
    def get_context_data(self, **kwargs):
        ...
        context['culture_entities'] = self.get_seller_section_entities(Seller_Profile.food)
        ...
        context['sellers'] = Seller_Profile.objects.all()
