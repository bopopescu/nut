...
from apps.web.views.article import ArticleList, EditorArticleList, EditorArticleCreate,EditorArticleEdit,ArticleDetail
...
urlpatterns = patterns(
    ...
    url(r'^(?P<pk>\d+)/page/',ArticleDetail.as_view(),name='web_article_page'),
)
