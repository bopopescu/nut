...
from apps.seller.views.web import SellerView, NewSellerView, ShopsView, OpinionsView, ColumnsView, TopicsView
...
urlpatterns += patterns('',
            ...
            url(r'^topics2016/', TopicsView.as_view(), name='year_store_2016_topics'),
