...
from apps.web.views.seller_management import SKUListView,SKUDeleteView,SKUUpdateView, \
                                             ...
                                             SKUStatusChangeView,SKUCreateView, QrcodeListView,image,delete_image
