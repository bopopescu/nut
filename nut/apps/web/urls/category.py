...
urlpatterns = patterns(
    ...
    url(r'^group/(?P<gid>\d+)/$', NewCategoryGroupListView.as_view(), name='web_category_group'),
    url(r'^group/(?P<gid>\d+)/(?P<order_by>[\w-]+)/$', NewCategoryGroupListView.as_view(), name='web_category_group'),
