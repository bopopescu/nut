...
from braces.views import StaffuserRequiredMixin, AjaxResponseMixin, JSONRequestResponseMixin
...
class DailyPushSendTestView(StaffuserRequiredMixin, SingleObjectMixin, AjaxResponseMixin, JSONRequestResponseMixin,
                            View):
    model = DailyPush
...
class DailyPushSendProductionView(StaffuserRequiredMixin, SingleObjectMixin, AjaxResponseMixin,
