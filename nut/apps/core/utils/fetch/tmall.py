...
def get_tmall_header():
    tmall_header = {
        ...
        'Cookie': 'cna=0Ai+Dj55yiUCAXc5ok0b91SC; thw=cn; miid=7682349312465627975; lzstat_uv=33312292761828985002|2144678@3073248; _m_h5_tk=4c02c4397896598d8e1e9c5a1ee92e00_1462467152976; _m_h5_tk_enc=d3c43ae9eaeb5af953124933849ec83e; _tb_token_=gtiwHhTaL6yZ; v=0; ubn=p; ucn=center; uc1=cookie14=UoWxM%2FethojmWQ%3D%3D&existShop=false&cookie16=V32FPkk%2FxXMk5UvIbNtImtMfJQ%3D%3D&cookie21=V32FPkk%2Fhw%3D%3D&tag=7&cookie15=UIHiLt3xD8xYTw%3D%3D&pas=0; uc3=sg2=UoH7K1l1Z0FWdsAYFNvBM3uCXawD4XEkPWQpIptFBN4%3D&nk2=An0Djlj77BMQ&id2=UUBQaOmbIlVcxg%3D%3D&vt3=F8dASmmIvFsh9%2BipXGk%3D&lg2=UIHiLt3xD8xYTw%3D%3D; existShop=MTQ2Mjk1NDM5OA%3D%3D; uss=AiSkN%2FJqM%2BVJnC0CXiex1K8aPwoO0QFrdB5sa10nh%2FmuywiiqDAVGVSe; lgc=alongtest; tracknick=alongtest; cookie2=5d0ff80aee4192afe4c3f816c5f5f5ac; sg=t97; mt=np=&ci=0_0&cyk=0_0; cookie1=ACy8q4vZR4RpOWusJer8b8g%2FAsTHeiYjeUSZMq8HGFc%3D; unb=2884665859; skt=f95013992a668f70; t=500ead4eee0c34700e8fdc28db59cb3c; _cc_=UtASsssmfA%3D%3D; tg=5; _l_g_=Ug%3D%3D; _nk_=alongtest; cookie17=UUBQaOmbIlVcxg%3D%3D; l=Aj4-Rl2OHk2hvhy0dOQNw0VlDl6AWQL5',
...
def fix_script_url(script_url):
    ...
    l = list()
    prepend = ''
    if not 'https:' in script_url:
        prepend = 'https:'           # use https
    ...
    if entity_info['isSuccess']:
        try:
            ...
            for k,v in priceInfo.iteritems():
                ...
                if priceInfo[k].get('promotionList') and len(priceInfo[k].get('promotionList')):
                # if priceInfo[k]['promotionList'] and len(priceInfo[k]['promotionList']):
                     for promo in priceInfo[k]['promotionList']:
                         try :
                             ...
                             continue
                elif priceInfo[k].get('suggestivePromotionList'):
                    try:
                        prices.append(priceInfo[k].get('suggestivePromotionList')[0]['price'])
                    except KeyError:
                        continue
