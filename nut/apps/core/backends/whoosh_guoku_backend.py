...
from haystack.backends.whoosh_backend import WhooshSearchBackend, WhooshSearchQuery
...
class GkSearchBackend(WhooshSearchBackend):
...
class GkEngine(BaseEngine):
    backend = GkSearchBackend
