...
insert into core_entity (id, user_id, entity_hash, brand, title, intro, price, mark, chief_image, detail_images, created_time, updated_time, status) 
	select id, creator_id, entity_hash, brand, title, intro, price, mark, chief_image, detail_images, created_time, updated_time, weight from guoku.base_entity
```
...
select id, creator_id, entity_id, note, created_time, updated_time from guoku.base_note;5
```
